...
app.post('/addAssetBatch', (req, res) => 
{
    ...
    return networkTools.invokeTransactionBatch(startFrom, numOfAssets, username, orgName, orgNumber, res);
});


app.post('/addAssetBatch_multiFile', (req, res) => 
{
    let username = req.body.username;
    let org = req.body.orgName;
    let numOfAssets = +req.body.numOfAssets;
    ...
    return networkTools.invokeTransactionBatch_MultiFile(startFrom, numOfAssets, username, orgName, orgNumber, res);
});
